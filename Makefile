...
qemu: clean myos.iso
	qemu-system-x86_64 -enable-kvm -cpu host -serial file:out.log -m 4G -smp 12 -cdrom myos.iso

debug: clean myos.iso
	qemu-system-x86_64 -enable-kvm -cpu host -s -S -serial file:out.log -m 8G -smp 4 -cdrom myos.iso
